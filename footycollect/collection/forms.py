...
from .models import Jersey, Shorts, Outerwear, Tracksuit, Pants, OtherItem, BaseItem, Size
...
class ItemPhotosForm(forms.Form):
    ...
    photos = MultipleFileField(
        ...
        help_text=_("You can upload up to 20 photos. First photo will be the main one.")
    )
    ...
    def clean_photos(self):
        ...
        if len(photos) > 20:
            raise forms.ValidationError(_("You can't upload more than 20 photos."))
        return photos
