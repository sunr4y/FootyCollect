...
urlpatterns = [
    ...
    path('items/<int:item_id>/reorder-photos/', views.reorder_photos, name='reorder_photos'),
    path('items/<int:pk>/', views.ItemDetailView.as_view(), name='item_detail'),
    path('upload/', views.file_upload, name='file_upload'),
    path('test-dropzone/', views.DropzoneTestView.as_view(), name='test_dropzone'),
    path('handle-dropzone-files/', views.handle_dropzone_files, name='handle_dropzone_files'),
]