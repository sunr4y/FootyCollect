...
MIGRATION_MODULES = {"sites": "footycollect.contrib.sites.migrations"}
...
ADMINS = [("""sunr4y""", "sunr4ydev@gmail.com")]
...
CELERY_BEAT_SCHEDULE = {
    "cleanup-orphaned-photos-daily": {
        "task": "footycollect.collection.tasks.cleanup_orphaned_photos",
        "schedule": 60.0 * 60.0 * 24.0,  # Every 24 hours
    },
    "cleanup-old-incomplete-photos-weekly": {
        "task": "footycollect.collection.tasks.cleanup_old_incomplete_photos",
        "schedule": 60.0 * 60.0 * 24.0 * 7.0,  # Every 7 days
    },
    "cleanup-all-orphaned-photos-monthly": {
        "task": "footycollect.collection.tasks.cleanup_all_orphaned_photos",
